...
const GAMBLE_REMINDER_LINES = [
  ...
  "see you in 8 hours!",
  "see you in another 8 hours or so",
  "lets run this back",
  ...
  "the lever has been pacing back and forth for 8 hours",
  "it is once again, lever o clock",
  "your regularly scheduled poor decision is now available",
  "i bring news from the casino",
  "the wait is over!!!",
  "this one feels huge, i cant explain why",
  "your 8 hour subscription has expired",
  "the house said you're welcome back",
  "hi dere",
  "i shook the machine a little its probably fine",
  "it would be really funny if you won big right now",
  "the machine has prepared a little something for you...",
  "the button looks lonely!",
  "its doing that thing again",
  "its those god damn weevils again!!",
  "8 hours later and you learned nothing",
  "you can cooldown your gamble again",
  "you can gamble your cooldown again",
  "you can your gamble",
  "i remember you're gambles",
  "pull responsibly",
  "we got another one!",
  "attention!! thing is ready",
  "the economy is ready for you to shake it up again",
  "this is your sign. not a good sign, just a sign",
  "xp incoming maybe perhaps theoretically",
  "its free xp until proven otherwise",
  "one tiny gamble couldnt hurt right",
  "good news! the bad idea is available again",
  "i cant stop you anymore",
  "it keeps getting away with this",
  "the machine has locked in",
  "did anyone tell you you're super awesome?",
  "its time for round whatever",
  "you can hear it too right",
  "the risk free, very normal activity has become available once more",
  "glamble",
  "roll up",
  "you know the drill!",
  "please enjoy this fresh cooldown completion"
];
